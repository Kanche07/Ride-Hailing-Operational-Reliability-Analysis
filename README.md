...
Driver churn increasing to 24.10%
Fare dispute rates reaching 19.98%
GPS lag affecting 20.60% of app sessions
App crash rates reaching 14.96%
Revenue exposure exceeding $254K from disputed fares

This project develops a centralized Operational Reliability Dashboard to identify high-risk app versions, measure fare integrity risk, and support data-driven hotfix and rollback decisions.
